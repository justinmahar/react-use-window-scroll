 ...
 */
export function useScrollTo(options: { polyfillDisabled?: boolean } = {}): ScrollTo {
...
export type ScrollTo = (scrollToOptionsOrTop?: ScrollToOptions | number, left?: number) => void;

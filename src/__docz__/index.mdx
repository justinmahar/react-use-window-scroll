...
<div style={{
  ...
  <div>
    <h1>React Use Window Scroll</h1>
  </div>
  <div>
    <a href="https://github.com/devboldly/react-use-window-scroll/" target="_blank" rel="noopener noreferrer">
...
<a href="https://devboldly.github.io/react-use-window-scroll/useScrollTo#hook-example"><img src={demoGif} /></a>
